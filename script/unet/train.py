...
if __name__ == '__main__':
    ...
    current_path = os.path.join('E:/PycharmProjects/SegTorchProject/script/checkpoint/unet', current_time)
    ...
    # model_ckpt = "../checkpoint/unet/20210212_221154/models/state_dict_model_e_48.pt"
